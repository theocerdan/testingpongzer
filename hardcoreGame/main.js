...
var paddleL = Bodies.rectangle(20, GAME_HEIGHT / 2, PADDLE_WIDTH, PADDLE_HEIGHT, { 
  isStatic: true,
  label: "PaddleLeft",
  render: {
    fillStyle: "black"
...
var paddleR = Bodies.rectangle(GAME_WIDTH - 20, GAME_HEIGHT / 2, PADDLE_WIDTH, PADDLE_HEIGHT, { 
  isStatic: true,
  label: "PaddleRight",
  render: {
    fillStyle: "black",
